<%@ Page Title="" Language="C#" MasterPageFile="~/panel/yonetim.master" AutoEventWireup="true" CodeFile="konuEkle.aspx.cs" Inherits="panel_konuEkle" %>
    ...
    <form class="mail-option" runat="server">
        <div class="form-group col-lg-12">
            ...
            <div class="input-group date datepicker">
                <input id="konuAd" type="text" class="form-control" runat="server"><span class="input-group-addon"><i class="fa fa-user"></i></span>
            </div>
        </div>
